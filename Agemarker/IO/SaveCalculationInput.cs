...
namespace Agemarker.IO
{
    public partial class SaveCalculationInput
    {
        ...
        public void SaveToFile(double[] oxidesContent, double[] elementsContent, double[] elementsWeight, long multiplier, int intervalsNumber, AgemarkerCore.Data.Logarithm log, string fullPath)
        {
