...
void MultiplierWidget::setMultiplier()
{
    ...
    {
        Float m = ACL::FMath::round(this->getCalculationsNumber() / this->atomNorSum);
...
void MultiplierWidget::setCalculationsNumber()
{
    ...
    {
        Float n = ACL::FMath::round(this->atomNorSum * this->getMultiplier());
...
void MultiplierWidget::updateInputData(std::vector<Float> oxidesContent,
                                       ...
                                       std::vector<Float> elementsWeight)
{
    ...
    {
        Float oxideOxygen = ((oxidesContent[x]) - (oxidesPureElement[x]));
